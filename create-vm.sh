...
VBoxManage createmedium disk --filename roger-skyline.vdi --size 8192 --variant Fixed
...
VBoxManage modifyvm roger-skyline --natpf1 "guestssh,tcp,127.0.0.1,2222,,2222"
